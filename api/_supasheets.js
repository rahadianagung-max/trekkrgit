...
const SHEET_MAP = {
  ...
  Schedule:           { table: "schedule",            cols: ["sched_id","type","venue","area","date","start_time","end_time","courts","capacity","booked","price_per_player","status","whatsapp_url","note","level","gender"] },
