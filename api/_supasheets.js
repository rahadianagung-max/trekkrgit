...
const SHEET_MAP = {
  ...
  Venues:             { table: "venues",              cols: ["name","location","region","schedule","prize_pool","contact","logo_url","created_at","register_url","featured","sort_order","hidden","bank_name","bank_account","bank_holder","admin_wa"] },
  ...
  Schedule:           { table: "schedule",            cols: ["sched_id","type","venue","area","date","start_time","end_time","courts","capacity","booked","price_per_player","status","whatsapp_url","note","level","gender","prize_pool","freebies","game_name","court_name","maps_url","address"] },
